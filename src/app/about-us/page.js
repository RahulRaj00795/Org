...
const page = () => {
  return (
    <>
      <Head>
        <title>About Us - Pandya Foundation | Dr. Rajesh C. Pandya | Community Development</title>
        <meta name="description" content="Learn about Dr. Rajesh C. Pandya, founder of Pandya Foundation. A technology executive and humanitarian dedicated to community development, cultural preservation, and charitable initiatives in New Jersey and India." />
        <meta name="keywords" content="Dr. Rajesh C. Pandya, Pandya Foundation founder, about us, community development, Indian culture, Garba Night, New Jersey, charity, technology executive" />
        <link rel="canonical" href="https://pandyafoundation.org/about-us" />

        {/* Open Graph */}
        <meta property="og:title" content="About Us - Pandya Foundation | Dr. Rajesh C. Pandya" />
        <meta property="og:description" content="Learn about Dr. Rajesh C. Pandya, founder of Pandya Foundation. Dedicated to community development and cultural preservation." />
        <meta property="og:url" content="https://pandyafoundation.org/about-us" />
        <meta property="og:type" content="website" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About Us - Pandya Foundation | Dr. Rajesh C. Pandya" />
        <meta name="twitter:description" content="Learn about Dr. Rajesh C. Pandya, founder of Pandya Foundation. Dedicated to community development and cultural preservation." />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "Technology executive, strategist, and humanitarian with over 32 years of experience in Information Technology and business services",
              "url": "https://pandyafoundation.org/about-us",
              "sameAs": [
                "https://pandyafoundation.org"
              ],
              "knowsAbout": ["Technology", "Business Strategy", "Community Development", "Cultural Preservation", "Philanthropy"],
              "hasOccupation": {
                "@type": "Occupation",
